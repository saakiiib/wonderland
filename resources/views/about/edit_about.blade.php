...
<div class="card-body">
    <form class="needs-validation" method="post" action="#" novalidate>
        <div class="mb-1">
            ...
            <input type="text" id="basic-addon-name" class="form-control" placeholder="Title" aria-label="Name"
        ...
        <div class="mb-1">
            ...
            <textarea class="form-control" id="validationBioBootstrap" placeholder="Description"
                name="category_description" rows="3" required></textarea>
        </div>
        {{-- <div class="mb-1">
