                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <form class="auth-register-form mt-2" action="{{ URL::to('admin-login-check') }}"
                                    method="POST">
                                    <div class="mb-1">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input class="form-control form-control-merge" id="register-password"
                                                ...
                                                aria-describedby="register-password" tabindex="3" required /><span
                                ...
                                <p class="text-center mt-2">
                                    <span>Want to create new admin?</span><a
                                        href="{{ URL::to('admin-register') }}"><span>&nbsp;Register instead</span></a>
                                </p>
                            </div>
                        </div>
